...
class MaskIC {
  //* - Validators
  ///[cRequired]--[email]--[password]--[phonePtBr]--[cep]--[cnpj]--[cpf]
  //
  //* - functions
  ...
  static MaskInputController email(BuildContext context) {
    FocusNode? focusNode;
  ...
  static MaskInputController password(BuildContext context) {
    FocusNode? focusNode;
    return MaskInputController(
      getFocusNode: () {
        focusNode = focusNode ?? FocusNode();
