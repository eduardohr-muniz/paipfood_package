class ServerException implements Exception {
  ...
  Map get mensageError => <int, String>{
        ...
        407: message407 ?? 'Proxy Authentication Required (autenticação de proxy necessária))',
        ...
        415: message415 ?? 'Unsupported Media Type (tipo de mídia não suportado)',
        ...
        505: message505 ?? 'HTTP Version Not Supported  (versão HTTP não suportada)',
      };
}
