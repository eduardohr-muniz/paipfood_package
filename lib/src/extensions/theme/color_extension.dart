...
class ColorExtension {
  static const Color primaryColor = Color(0xffA0E548); //* Light
  static const Color secondaryLight = Color(0xff9AC1F0);
  static const Color tertiaryLight = Color(0xffee8b60);
  static const Color alternateLight = Color(0xffff5963);
  ...
  static const Color secondaryTextLight = Color(0xff202024);
  ...
  static const Color primaryBackgroundDark = Color(0xff121214);
  static const Color secondaryBackgroundDark = Color(0xff202024);
  static const Color primaryTextDark = Color(0xffF5F6FA);
  static const Color secondaryTextDark = Color(0xffD5D7E3);
